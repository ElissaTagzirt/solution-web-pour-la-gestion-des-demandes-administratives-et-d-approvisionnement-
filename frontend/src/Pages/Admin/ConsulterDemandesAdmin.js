...
const ConsulterDemandesUser = () => {
    ...
    useEffect(() => {
        const fetchData = () => {
          fetch('http://127.0.0.1:8000/Demandes/UsersDemandes/', {
            headers: {
                        ...
                        <button
                          ...
                          >
                            ...
                            <button
                              ...
                              className="inline-block ml-2 px-2 flex mr-3 shadow py-2 bg-[#52B8B5] text-white rounded-md hover:bg-indigo-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 float-right"
                            >
                          ...
                          {["Validée", "Annuler", "inatteignable"].includes(item.StatueDemande) && (
                           ...
                           <button
                              ...
                              className="inline-block px-2 flex mr-2  shadow py-2 bg-[#52B8B5] text-white rounded-md hover:bg-indigo-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 float-right"
                            >
                              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1} stroke="currentColor" className="w-4 h-5">
...
export default ConsulterDemandesUser;